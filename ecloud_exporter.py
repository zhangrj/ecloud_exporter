...
class EcloudMonitor:
    ...
    def convert_to_prometheus_format(resource_id, resource_name, product_type, performance_list) -> str:
        ...
        for performance in performance_list:
            if performance.childnode == True and performance.datapoints is not None and len(performance.datapoints) > 0:
            ...
            elif performance.childnode == False and performance.datapoints is not None and len(performance.datapoints) > 0:
